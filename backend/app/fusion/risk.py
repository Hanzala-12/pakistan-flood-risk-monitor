...
responsibly on yet. A weighted sum of three interpretable 0..1 signals is the
...
def fuse_risk(water_anomaly: float, rainfall_anomaly: float, terrain_susceptibility: float) -> FusionResult:
